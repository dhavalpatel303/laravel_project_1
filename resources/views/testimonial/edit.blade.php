...
<html dir="ltr" lang="en">
    <head>
        <title>{{helpers::name()}} | Edit Testimonial</title>
    </head>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit New Testimonial</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        @endif
                        <div class="card">
                          {!! Form::model($testimonial, ['method' => 'PATCH','route' => ['testimonial.update', encrypt($testimonial->id)],'files' => 'true','enctype'=>'multipart/form-data']) !!}
                                <div class="form-body">
                                    <div class="card-body">
                                        <div class="row">
