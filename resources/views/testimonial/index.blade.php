...
<html dir="ltr" lang="en">
    <head>
        <title>{{helpers::name()}} | Testimonial</title>
    </head>
...
<body>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-auto">
                                        ...
                                        <a href="{{route('testimonial.create')}}" class="btn btn-info card-title">Add New <i class="fa fa-plus"></i></a>
                                    </div>
 ...
 <script>
     ...
     $(document).on('click','button#deleteAllBtn',function(){
        ...
        var url = '{{route("testimonial.deleteAll")}}';
