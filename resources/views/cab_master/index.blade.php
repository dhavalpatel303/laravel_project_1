...
<html dir="ltr" lang="en">
    <head>
        <title>{{helpers::name()}} | Cab Master</title>
    </head>
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Cab Master</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Admin</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cab Master</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-auto">
                                        ...
                                        <a href="{{route('cab_master.create')}}" class="btn btn-info card-title">Add New <i class="fa fa-plus"></i></a>
                                    </div>
                                    ...
                                    <table id="list-table" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> Cab Name</th>
                                                <th>Cab Image</th>
                                                <th>Available Cabs</th>
                                                <th>Seats/Bags</th>
                                                {{-- <th>Bags</th> --}}
                                                <th>Oneway/Round Trip Km Rate</th>
   ...
   <script>
    $(function () {
        ...
        var table = $('#list-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('cab_master.index') }}",
            columns: [
                {data: 'checkbox', name: 'checkbox',orderable: false, searchable: false},
                {data: 'DT_RowIndex',    name: 'DT_RowIndex'},
                {data:'cab',     name:'cab',width:"40%"},
                {data:'image',     name:'image'},
                {data:'av_cabs',     name:'av_cabs',width:"80%"},
                {data:'seat',     name:'seat'},
                // {data:'bag',     name:'bag'},
                {data:'km_rate',     name:'km_rate',width:"80%"},
                // {data:'mkm_rate',     name:'mkm_rate'},
                // {data:'ekm_rate',     name:'ekm_rate'},
 ...
 <script>
     ...
     $(document).on('click','button#deleteAllBtn',function(){
        ...
        var url = '{{route("cab_master.deleteAll")}}';
        if(checkedcity.length > 0)
        {

            swal.fire({
                title:'Are You Sure?',
                html:'You want to delete <b>('+checkedcity.length+')</b>pickup city',
