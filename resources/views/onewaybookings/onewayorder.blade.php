                                            ...
                                            <div id="print" style="width: 700px; height: auto; border: 1px solid #c1c1c1; margin: 0 auto 100px; font-size: 15px; background-color: #f1f1f1; box-shadow: 0 0 20px #777777ad !important;">
                                                <div style="border-bottom: 1px solid #c1c1c1; height: auto; padding: 15px;">
                                                    <div style="width: 55%; text-align: left; display: inline-block;">
                                                        <br />
                                                        <b style="color: #6e6b7b;">{{helpers::name()}}</b><br />
                                                        <b style="color: #6e6b7b;">Address : </b>{{helpers::address()}}<br />
                                                        <b style="color: #6e6b7b;">Contact:</b>&nbsp;+91 {{helpers::mobile()}}<br />
                                                        <b style="color: #6e6b7b;">Email Us:</b><span style="color: #2e93e4;">&nbsp;{{helpers::email()}}</span>
                                                    </div>
                                                        ...
                                                        <table style="width: 100%;">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><span style="font-size: 14px;">{{trim(date_format(date_create($result->pickup_date),'d-m-Y'))}}, {{$result->pickup_time}}</span></td>
                                                                    <td>
                                                                        <span><b>Booked On : </b></span>
                                                                    </td>
                                                                    <td><span style="font-size: 14px;">{{trim(date_format(date_create($result->created_at),'d-m-Y'))}}</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td ><span><b>Pickup City : </b></span></td>
                                                                    <td><span style="font-size: 14px;">{{$result->pick_city}}</span></td>
                                                                    <td>
                                                                        <span><b>Car Booked : </b> </span>
                                                                    </td>
                                                                    <td><span style="font-size: 14px;">{{$result->cab_type}}</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td ><span><b>Rental Type  : </b></span></td>
                                                                    <td colspan="3"><span style="font-size: 14px;">Oneway ({{$result->pick_city}} - {{$result->drop_city}})</span></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="2" style="text-align: left;">
                                                                    <span style="color: #2e93e4;"><b>Customer Details</b></span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr style="line-height: 1.5;">
                                                                <td style="text-align: left;">
                                                                    <span><b>Drop City</b></span>
                                                                </td>
                                                                <td style="text-align: left;"><span>{{$result->drop_city}}</span></td>
                                                            </tr>
                                                            <tr style="line-height: 1.5;">
                                                                <td style="text-align: left;">
                                                                    <span><b>Drop Location</b></span>
                                                                </td>
                                                                <td style="text-align: left;"><span>{{$result->drop_location}}</span></td>
                                                            </tr>
                                                            <tr style="line-height: 1.5;">
                                                                <td style="text-align: left;">
                                                ...
                                                <div style="width: 335px; display: inline-block; padding: 15px; vertical-align: top;">
                                                    <table style="text-align: center; border-collapse: collapse; font-size: 13.5px;">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="2" style="text-align: left;">
                                                                    <span style="color: #2e93e4;"><b>Estimated Taxi Fare</b></span>
                                                                </td>
                                                            </tr>
                                                            <tr style="line-height: 1.5;">
                                                                <td style="width: 195px; text-align: left;">
                                                                    <span><b>Base Fare</b></span>
                                                                </td>
                                                                <td style="text-align: right;"><span>Rs {{$onewaydetail->amount}}/-</span></td>
                                                            </tr>

                                                            <tr style="line-height: 1.5;">
                                                                <td style="text-align: left;">
                                                                    <span><b>Tall Tax</b></span>
                                                                </td>
                                                                <td style="text-align: right;"><span>@if($onewaydetail->tax == '')Include @elseif($onewaydetail->tax == 0) Include @else Rs. {{$onewaydetail->tax}}/- @endif</span></td>
                                                            </tr>

                                                            <tr style="line-height: 1.5;">
                                                                <td style="text-align: left;">
                                                                    <span><b>State Tax</b></span>
                                                                </td>
                                                                <td style="text-align: right;">
                                                                    <span>@if($onewaydetail->state_tax == '')Include @elseif($onewaydetail->state_tax == 0) Include @else Rs. {{$onewaydetail->state_tax}}/- @endif</span>
                                                                </td>
                                                            </tr>

                                                            <tr style="line-height: 1.5;">
                                                                <td style="text-align: left;">
                                                                    <span><b>Driver Allowance</b></span>
                                                                </td>
                                                                <td style="text-align: right;">
                                                                    <span>@if($onewaydetail->driver_allowance == '')Include @elseif($onewaydetail->driver_allowance == 0) Include @else Rs. {{$onewaydetail->driver_allowance}}/- @endif</span>
                                                                </td>
                                                            </tr>

                                                            <tr style="line-height: 1.5;">
                                                                <td style="text-align: left;">
                                                                    <span><b>Trip Discount</b></span>
                                                                </td>
                                                            ...
                                                            <tr style="line-height: 1.5;">
                                                                <td style="text-align: left;">
                                                                    <span><b>Estimated Trip Fare</b></span>
                                                                </td>
