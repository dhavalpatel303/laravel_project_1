...
<head>
    <title>{{helpers::name()}} | Create Onewaybooking</title>
</head>
            ...
            <div class="content-header row">
                <div class="content-header-left caol-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Create Oneway Booking</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Oneway Booking</h4>
                                </div>
                                <div class="card-body">

                                    {!! Form::open(array('route' => 'onewaybookings.store','class'=>'form form-horizontal','method'=>'POST','files' => 'true','enctype'=>'multipart/form-data')) !!}
                                            <div class="row col-12">
                                                    ...
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                {!! Form::select('pickupcity_id', $pickupcity_id,[], array('class' => 'form-select form-select-lg','id'=>'pickupcity_id','for'=>'select2-basic','required')) !!}
                                                            </div>
                                                ...
                                                <div class="col-3 mobile-width">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <select class="form-select form-select-lg" name ="dropcity_id" id="dropcity_id" required="true">
                                            ...
                                            <div class="row col-12">
                                                <div class="col-3 mobile-width">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                <input type="date" class="form-control form-select-lg" id="pickup_date" name="pickup_date" required placeholder="{{date("d/m/Y ")}}" readonly>
                                                            </div>
                                                ...
                                                <div class="col-3 mobile-width">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <select class="form-select form-select-lg" name ="gross_total" id="gross_total" selected style="background-image: none">
                                                    ...
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                ...
                                                                {{-- {!! Form::text('customer_mobile', null, array('placeholder' => 'Customer Mobile','id'=>'customer_mobile','class' => ' ','maxlength' => 10 )) !!} --}}
                                                            </div>
                                  ...
                                  {!! Form::hidden('onewaydetail_id', null, array('placeholder' => '','id'=>'onewaydetail_id','name'=>'onewaydetail_id','class' => 'form-control form-select-lg')) !!}
                                            ...
                                            <div class="row col-12">
                                                <div class="col-6 mobile-width">
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-12">
                                                         ...
                                                         <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                {!! Form::textarea('pickup_location', null, array('placeholder' => 'Pickup Location','class' => 'form-control form-select-lg','rows'=>4,'required')) !!}
                                                            </div>
                                                ...
                                                <div class="col-6 mobile-width">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                {!! Form::textarea('drop_location', null, array('placeholder' => 'Drop Location','class' => 'form-control form-select-lg','rows'=>4,'required')) !!}
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12" style="text-align: center">
                                                    <button type="submt" class="btn btn-primary me-1 waves-effect waves-float waves-light">Submit</button>
                                                    {!! Form::close() !!}
