...
<html dir="ltr" lang="en">
    <head>
        <title>{{helpers::name()}} | Increase Descrease List</title>
    </head>
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Increase Descrease List</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Admin</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Increase Descrease List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h4>Increase Descrease List</h4>
                                        <button class="btn btn-danger me-1 waves-effect waves-float waves-light  d-none" id="deleteAllBtn">Delete All</button>
                                    </div>
                                    <div class="ml-auto">

                                        <a href="{{route('onewaydetails.increase')}}" class="btn btn-info card-title">Add New <i class="fa fa-plus"></i></a>
                                    </div>

                                </div>
                                <div class="table-responsive">
                                    <table id="list-table" class="table table-striped table-bordered" style="width: 940px">
                                        <thead>
                                            <tr>
 ...
 <script>
     ...
     $(document).on('click','button#deleteAllBtn',function(){
        ...
        var url = '{{route("increse_deleteAll")}}';
