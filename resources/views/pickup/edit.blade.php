...
<html dir="ltr" lang="en">
    <head>
        <title>{{helpers::name()}} | Update City</title>
    </head>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        @endif
                        <div class="card">
                            {!! Form::model($pickup, ['method' => 'PATCH','route' => ['pickup.update', ($pickup->id)]]) !!}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name ="state_id" id="state_id">
                                                     ...
                                                     <option value="{{$state_id->id}}"{{($pickup->state_id==$state_id->id)? 'selected':''}} >{{$state_id->name}}</option>
                                                     @endforeach
                                                 </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('pick_city', null, array('placeholder' => 'Enter City Name','id'=>'pick_city','class' => 'form-control','required'=>'true')) !!}
