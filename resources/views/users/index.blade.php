...
<html dir="ltr" lang="en">
    <head>
        <title>{{helpers::name()}} | User List</title>
    </head>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-auto">
                                        ...
                                        <a href="{{route('users.create')}}" class="btn btn-info card-title">Add New <i class="fa fa-plus"></i></a>
                                    </div>
       ...
       $(function () {
           ...
           var table = $('#list-table').DataTable({
               ...
               columns: [
                   ...
                   {data: 'user_mobile',           name: 'user_mobile',width:'15%'},
