            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        @endif
                        <div class="card">
                            {!! Form::open(array('route' => 'driver_multyway','class'=>'form form-horizontal','method'=>'POST','files' => 'true','enctype'=>'multipart/form-data')) !!}
                            <div class="form-body">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="multy_id" name="multy_id" value="{{$multy_id}}">
