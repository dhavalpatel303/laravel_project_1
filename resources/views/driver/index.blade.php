...
<html dir="ltr" lang="en">
    <head>
        <title>{{helpers::name()}} | Driver Details</title>
    </head>
...
<body>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-auto">
                                        ...
                                        <a href="{{route('driver.create')}}" class="btn btn-info card-title">Add New <i class="fa fa-plus"></i></a>
                                    </div>
    ...
    $(function () {
        ...
        var table = $('#list-table').DataTable({
            ...
            columns: [
                ...
                {data: 'cab_name',           name: 'cab_name'},
                {data: 'cab_number',           name: 'cab_number'},
 ...
 <script>
     ...
     $(document).on('click','button#deleteAllBtn',function(){
        ...
        var url = '{{route("driver.deleteAll")}}';
