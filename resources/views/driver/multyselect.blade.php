...
<body>
 ...
 <input type="hidden" name="multyid" id=multyid value="{{$multyid}}">
                                ...
                                <div class="table-responsive">
                                    <table id="list-table" class="table table-striped table-bordered">
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td> <a onclick="driverselect(<?=$value->id?>)" id="select" class="btn btn-success me-1 waves-effect waves-float waves-light" style="color: rgb(15, 13, 13)" ><i class="fa fa-eye "></i> Select</a></td>
                                        </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
   ...
   <script>
    function driverselect(id)  {
                           ...
                           var driverselect = id;
                           var multyid = jQuery("#multyid").val();
                           jQuery.ajax({
                            headers: {
                            'X-CSRF-Token': $('input[name="_token"]').val()
                                        },
                               type: "Post",
                               url: "{{route('multydataselect')}}",
                               data:{driverselect:driverselect,multyid: multyid},
