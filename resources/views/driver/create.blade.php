            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        @endif
                        <div class="card">
                            {!! Form::open(array('route' => 'driver.store','class'=>'form form-horizontal','method'=>'POST','files' => 'true','enctype'=>'multipart/form-data')) !!}
                            <div class="form-body">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                ...
                                <div class="form-actions">
                                    <div class="card-body">
                                        ...
                                        <a href="{{route('driver.index')}}" class="btn btn-dark">Cancel</a>
                                    </div>
                                </div>
                            </div>
