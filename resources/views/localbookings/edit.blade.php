...
<head>
    <title>{{helpers::name()}} | Edit Localbookings</title>
</head>
            ...
            <div class="content-header row">
                <div class="content-header-left caol-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Local Booking</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Local Details</h4>
                                </div>
                                <div class="card-body">

                                    {!! Form::model($localbookings, ['method' => 'PATCH','route' => ['localbookings.update', encrypt($localbookings->id)]]) !!}
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select class="form-select form-select-lg" name ="pickupcity_id" id="pickupcity_id">
                                                                    ...
                                                                    <option value="{{$pickcity->p_id}}"{{($localbookings->pickupcity_id==$pickcity->p_id)? 'selected':''}} >{{$pickcity->pick_city}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <select class="form-select form-select-lg" name ="dropcity_id" id="dropcity_id">
                                                                <option {{($localbookings->dropcity_id=='4Hr/40KMs')? 'selected' : ''}} value="4Hr/40KMs">4Hr/40KMs</option>
                                                                <option {{($localbookings->dropcity_id=='6Hr/60KMs')? 'selected' : ''}} value="6Hr/60KMs">6Hr/60KMs</option>
                                                                <option {{($localbookings->dropcity_id=='8Hr/80KMs')? 'selected' : ''}} value="8Hr/80KMs">8Hr/80KMs</option>
                                                                <option {{($localbookings->dropcity_id=='10Hr/100KMs')? 'selected' : ''}} value="10Hr/100KMs">10Hr/100KMs</option>
                                                                <option {{($localbookings->dropcity_id=='12Hr/120KMs')? 'selected' : ''}} value="12Hr/120KMs"  >12Hr/120KMs</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <select class="form-select form-select-lg" name ="cab_type" id="cab_type">
                                                                <option {{($localbookings->cab_type=='Sedan')? 'selected' : ''}} value="Sedan" >Sedan</option>
                                                                <option {{($localbookings->cab_type=='Suv')? 'selected' : ''}} value="Suv">Suv</option>
                                                                <option {{($localbookings->cab_type=='Innova')? 'selected' : ''}} value="Innova">Innova</option>
                                                                <option {{($localbookings->cab_type=='Innovacrysta')? 'selected' : ''}} value="Innovacrysta">Innovacrysta</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row col-12">
                                                <div class="col-3 mobile-width">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                {!! Form::text('pickup_date', null, array('placeholder' => 'Pickup date','id'=>'pickup_date','class' => 'form-control form-select-lg date','readonly'=>'true')) !!}
                                                            </div>
                                                            ...
                                                            <select class="form-select form-select-lg"  name ="pickup_time" id="pickup_time" required='required' >
                                                                ...
                                                                for($hours=0; $hours<24; $hours++){ // the interval for hours is '1'
                                                                  ...
                                                                  for($mins=0; $mins<60; $mins+=60){ // the interval for mins is '30'
                                                                       $sel="";
                                                                      if($localbookings->pickup_time == str_pad($hours,2,'0',STR_PAD_LEFT).':'.str_pad($mins,2,'0',STR_PAD_LEFT)){
                                                    ...
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <select class="form-select" name ="gross_total" id="gross_total" readonly="readonly" >
                                                                <option {{($localbookings->gross_total)? 'selected' : ''}} >{{$localbookings->gross_total}}</option>
                                                            </select>
                                                            {{-- <input type="text" class="form-control form-select-lg" id="gross_total" name="gross_total"  value="{{$localbookings->gross_total}}" readonly> --}}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-3 mobile-width">
                                            ...
                                            <div class="row col-12">
                                                <div class="col-3 mobile-width">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                <input type="text" class="form-control form-select-lg" id="total_amount" name="total_amount"  value="{{$localbookings->total_amount}}" readonly>
                                                            </div>
                                                ...
                                                <div class="col-6 mobile-width">
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-12">
                                                         ...
                                                         <div class="col-sm-12">
                                                            <input type="text" class="form-control form-select-lg" id="alternet_mobile" name="alternet_mobile" value="{{$localbookings->alternet_mobile}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row col-12">
                                                <div class="col-6 mobile-width">
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-12">
                                                         ...
                                                         <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                {!! Form::textarea('pickup_location', null, array('placeholder' => 'Pickup Location','class' => 'form-control form-select-lg','rows'=>5)) !!}
                                                            </div>
                                                ...
                                                <div class="col-6 mobile-width">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="input-group input-group-merge">
                                                                {!! Form::textarea('drop_location', null, array('placeholder' => 'drop Location','class' => 'form-control form-select-lg','rows'=>5)) !!}
                                                            </div>
                                            ...
                                            <div class="col-sm-12 offset-sm-3 pl">
...
<script>
    ...
    {{-- <script>
        jQuery(document).ready(function(){
...

            {
                ...
                jQuery.ajax({
                    url:"{{route('localbookings.updateDropcity')}}",
                    type:'post',
                    data:'pid='+pid+
                    '&_token={{csrf_token()}}',
    ...
    <script>
        ...
        $("#close").click(function(){
            ...
            window.location.replace('{{route('localbookings.index')}}');
        });
        </script>
</body>
<!-- END: Body-->
