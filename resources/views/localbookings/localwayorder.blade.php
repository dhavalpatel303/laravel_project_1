                                                ...
                                                <div id="print" style="width: 700px;height: auto;border: 1px solid #c1c1c1;margin: 0 auto 100px;font-size: 15px;background-color: #f1f1f1;box-shadow: 0 0 20px #777777ad !important;">
                                                  ...
                                                  <div style="height:auto;padding:15;border-bottom: 1px solid #c1c1c1;">
                                                      <div style="width:100%;text-align: left;">
                                                         <table style="width: 100%;">
                                                          ...
                                                          <td  colspan="3"><span style="font-size: 14px;">Local Way ({{$result->pick_city}} - {{$local_package->local_package}})</span></td>
                                                          </tr>
                                                         </tbody></table>
                                                  ...
                                                  <div style="width:335px;display:inline-block;border-right: 1px solid #c1c1c1;padding: 15px;vertical-align: top;height: 360px;max-height: 370px;">
                                                    <table style="text-align:center;border-collapse:collapse;font-size: 13.5px;">
                                                        ...
                                                        <tr style="line-height: 1.5;">
                                                          <td style="text-align: left;"><span><b>Local Package</b></span> </td>
                                                  ...
                                                  <div style="width:335px;display:inline-block;padding: 15px;vertical-align: top;">
                                                    <table style="text-align:center;border-collapse:collapse;font-size: 13.5px;">
                                                      ...
                                                      <tr style="line-height: 1.5;">
                                                        ...
                                                        <td style="text-align: right;"><span>Rs {{$localdetail->amount}}/-</span> </td>
                                                      </tr>

                                                      <tr style="line-height: 1.5;">
                                                        <td style="text-align: left;"><span><b>Extra Hours</b></span> </td>
                                                        <td style="text-align: right;"><span>@if($localdetail->hours == '')Include @elseif($localdetail->hours == 0) Include @else {{$localdetail->hours}} Hours @endif</span> </td>
                                                      </tr>



                                                  <tr style="line-height: 1.5;">
                                                    <td style="text-align: left;"><span><b>Extra Km</b></span> </td>
                                                    <td style="text-align: right;"><span>@if($localdetail->kms == '')Include @elseif($localdetail->kms == 0) Include @else {{$localdetail->kms}} Km @endif</span> </td>
                                                  </tr>
                                                  ...
                                                  <tr style="line-height: 1.5;">
                                                    ...
                                                    <td style="text-align: right;"><span>@if($localdetail->ehr == '')Include @elseif($localdetail->ehr == 0) Include @else Rs.{{$localdetail->ehr}}/Hours @endif</span> </td>
                                                  </tr>
                                                  <tr style="line-height: 1.5;">
                                                    <td style="text-align: left;"><span><b>Extra Km Rate</b></span> </td>
                                                    <td style="text-align: right;"><span>@if($localdetail->ekr == '')Include @elseif($localdetail->ekr == 0) Include @else Rs.{{$localdetail->ekr}}/Km @endif</span> </td>
                                                  </tr>
