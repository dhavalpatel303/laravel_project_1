...
<head>
    <title>{{helpers::name()}} | Localbookings</title>
</head>
                ...
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Local Booking List</h2>
        ...
        <script>
            $(function () {
                ...
                var table = $('#list-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('localbookings.index') }}",
                    columns: [
         ...
         <script>
             ...
             $(document).on('click','button#deleteAllBtn',function(){
                ...
                var url = '{{route("localbookings.deleteAll")}}';
