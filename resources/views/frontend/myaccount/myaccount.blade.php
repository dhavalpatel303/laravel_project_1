                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td class="product-thumb">
                                        <img src="{{asset('public/profile/'.$upcoming_oneway[$i]['image'])}}" alt="tire" class="img-fluid">
                                    </td>
                                    <td>
                                        <h6 class="mb-1">{{$upcoming_oneway[$i]['cab']}}</h6>
                                        
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">{{$upcoming_oneway[$i]['orderno']}}</span>
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">Oneway</span>
                                    </td>
                                    <td>
                                        <span class="price fw-bold"><i class="fa fa-inr"></i>{{$upcoming_oneway[$i]['total_amount']}}</span>
                               ...
                               <?php for ($i = 0; $i < count($upcoming_localway); $i++) { ?>
                                <tr>
                                    <td class="product-thumb">
                                        <img src="{{asset('public/profile/'.$upcoming_localway[$i]['image'])}}" alt="tire" class="img-fluid">
                                    </td>
                                    <td>
                                        <h6 class="mb-1">{{$upcoming_localway[$i]['cab']}}</h6>
                                        
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">{{$upcoming_localway[$i]['orderno']}}</span>
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">Local Package</span>
                                    </td>
                                    <td>
                                        <span class="price fw-bold"><i class="fa fa-inr"></i>{{$upcoming_localway[$i]['total_amount']}}</span>
                               ...
                               <?php for ($i = 0; $i < count($upcoming_multyway); $i++) { ?>
                                <tr>
                                    <td class="product-thumb">
                                        <img src="{{asset('public/profile/'.$upcoming_multyway[$i]['image'])}}" alt="tire" class="img-fluid">
                                    </td>
                                    <td>
                                        <h6 class="mb-1">{{$upcoming_multyway[$i]['cab']}}</h6>
                                        
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">{{$upcoming_multyway[$i]['orderno']}}</span>
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">Round-Trip</span>
                                    </td>
                                    <td>
                                        <span class="price fw-bold"><i class="fa fa-inr"></i>{{$upcoming_multyway[$i]['total_amount']}}</span>
                    ...
                    <div class="col-12">
                        ...
                        <div class="wishlist-table table-responsive bg-white">
                            <table class="table">
                                ...
                                <tr> 
                                    <td class="product-thumb">
                                        <img src="{{asset('public/profile/'.$complate_oneway[$i]['image'])}}" alt="tire" class="img-fluid">
                                    </td>
                                    <td>
                                        <h6 class="mb-1">{{$complate_oneway[$i]['cab']}}</h6>
                                        
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">{{$complate_oneway[$i]['orderno']}}</span>
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">Oneway</span>
                                    </td>
                                    <td>
                                        <span class="price fw-bold"><i class="fa fa-inr"></i>{{$complate_oneway[$i]['total_amount']}}</span>
                               ...
                               <?php for ($i = 0; $i < count($complate_localway); $i++) { ?>
                                <tr>
                                    <td class="product-thumb">
                                        <img src="{{asset('public/profile/'.$complate_localway[$i]['image'])}}" alt="tire" class="img-fluid">
                                    </td>
                                    <td>
                                        <h6 class="mb-1">{{$complate_localway[$i]['cab']}}</h6>
                                        
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">{{$complate_localway[$i]['orderno']}}</span>
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">Local Package</span>
                                    </td>
                                    <td>
                                        <span class="price fw-bold"><i class="fa fa-inr"></i>{{$complate_localway[$i]['total_amount']}}</span>
                               ...
                               <?php for ($i = 0; $i < count($complate_multyway); $i++) { ?>
                                <tr>
                                    <td class="product-thumb">
                                        <img src="{{asset('public/profile/'.$complate_multyway[$i]['image'])}}" alt="tire" class="img-fluid">
                                    </td>
                                    <td>
                                        <h6 class="mb-1">{{$complate_multyway[$i]['cab']}}</h6>
                                        
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">{{$complate_multyway[$i]['orderno']}}</span>
                                    </td>
                                    <td>
                                        <span class="stock-btn rounded-pill">Round-Trip</span>
                                    </td>
                                    <td>
                                        <span class="price fw-bold"><i class="fa fa-inr"></i>{{$complate_multyway[$i]['total_amount']}}</span>
            ...
            <div class="modal fade" id="cancle_modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog " >
                    <div class="modal-content" style="background-color: #f1f1f1">
                        ...
                        <div class="modal-body">
                            <div class="table-designs">
                                <span>Number :<b>(+91) {{helpers::mobile()}}</b></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
         ...
         <script>
            function oneway_view_popup(id) {
                ...
                jQuery.ajax({
                    type: "Post", 
                    url: "{{route('popup_values')}}",
                    data: "onewayupcoming_id=" + onewayupcoming_id + "&_token={{csrf_token()}}",
          ...
          <script>
            function localway_view_popup(id) {
                ...
                jQuery.ajax({
                    type: "Post",
                    url: "{{route('local_popup_values')}}",
                    data: "localwayupcoming_id=" + localwayupcoming_id + "&_token={{csrf_token()}}",
          ...
          <script>
            function multyway_view_popup(id) {
                ...
                jQuery.ajax({
                    type: "Post",
                    url: "{{route('multy_popup_values')}}",
                    data: "multyupcoming_id=" + multyupcoming_id + "&_token={{csrf_token()}}",
