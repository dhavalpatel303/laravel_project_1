    ...
    @include('frontend.layout._top_bar')
        ...
        <section class="breadcrumb-section position-relative z-2 overflow-hidden mt--75" data-background="{{asset('front-assets/assets/img/shapes/texture-bg.png')}}" style="background-image: url(&quot;{{asset('front-assets/assets/img/shapes/texture-bg.png')}}&quot;);">
            ...
            <section class="inner-blog-area mt_50">
              <div class="container">
                        <div class="faq-text">
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">Privacy & Policy</h2>
                                        <p>
                                            This Privacy Policy is an electronic record in the form of an electronic contract formed under the information Technology Act, 2000 and the rules made thereunder and the amended provisions pertaining to electronic documents / records in various statutes as amended by the information Technology Act, 2000. This Privacy Policy does not require any physical, electronic or digital signature.
                                        </p>
                                        <p>
                                            This Privacy Policy is a legally binding document between you and {{helpers::name()}}.in (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and {{helpers::name()}}.in for your use of the website “Website” (defined below).
                                        </p>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">USER INFORMATION</h2>
                                        <p>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">COOKIES</h2>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">INFORMATION SHARING</h2>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">INFORMATION SECURITY</h2>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">Grievance Redressal</h2>
                                        ...
                                        <p>www.{{helpers::name()}}.in<br>
                                            Company Name : {{helpers::name()}}<br>
                                            Mobile: +91 {{helpers::mobile()}}</p>
                                            <h2 style="margin-top:15px;margin-bottom:20px;color: #101010;font-size:24px;">TERMS AND CONDITIONS</h2>
                                            <h5 style="font-weight:800;color:#553939">The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to {{helpers::name()}}.in and the terms "You" /"Your" / "Yourself" refer to the users</h5>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">USE OF CONTENT</h2>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">ACCEPTABLE WEBSITE USE</h2>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">LIABILITY</h2>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">DISCLAIMER OF CONSEQUENTIAL DAMAGES</h2>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">Cancellation Policy</h2>
                                        ...
                                        <h2 style="margin-top:15px;color: #101010;font-size:24px;">Refund Policy</h2>
                                        <P>We will try our best to create the suitable design concepts for our clients. In case any client is not completely satisfied with our products we can provide a refund. If paid by credit card, refunds will be issued to the original credit card provided at the time of purchase and in case of payment gateway name payments refund will be made to the same account.</P>
                                        {{-- <a href="{{route('home.index')}}" type="submit" target="_blank" class="as-btn" tabindex="0">Exit</a> --}}
                                    </div>
                </div>
            </section>
