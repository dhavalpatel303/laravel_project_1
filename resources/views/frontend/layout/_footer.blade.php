 ...
 <a href="https://api.whatsapp.com/send?phone=+91{{helpers::mobile()}}&amp;text=hi%21%20%20" style="color: white;background-color:#3BB54A" target="_blank" class="mobile_none"><i class="fa-brands fa-whatsapp top_button show-mobile"></i></a>
 <div class="display_none">
    <div class="comunication_section" style="visibility: visible;">
        <div class="inside_comunication_section">
            <div class="sectionleft">
                <a href="tel:+91{{helpers::mobile()}}"></a>
                <div class="imgsec">
                    <a href="tel:+91{{helpers::mobile()}}">
            ...
            <div class="sectioncenter">
                <a href="whatsapp://send?phone=+91{{helpers::mobile()}}&amp;text=Hi!"></a>
                <div class="imgsec">
 ...
 <div class="modal fade " id="request_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <footer class="footer-section pt-50">
            ...
            <div class="footer-wrapper position-relative z-1 overflow-hidden pt-50" data-background="{{asset('front-assets/assets/img/shapes/texture-bg.png')}}">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="footer-widget widget-basic">
                                ...
                                <div class="phone-box d-flex align-items-center">
                                    ...
                                    <h4 class="text-white ms-3 mb-0">+91 {{helpers::mobile()}}</h4>
                                </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="ms-lg-5 ms-xl-0 mt-5 mt-lg-0">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <a href="{{route('home.index')}}" class="footer-logo d-inline-block"><img src="{{asset('front-assets/assets/img/logo.png')}}" alt="logo"></a>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-end">
                                ...
                                <div class="row mt-30">
                                    <div class="col-sm-4">
                                        <div class="footer-widget footer-nav-widget mb-5 mb-sm-0">
                                            ...
                                            <ul class="footer-nav">
                                                <li><a href="{{route('home.index')}}">Book Cab</a></li>
                                                <li><a href="{{route('service')}}">Service</a></li>
                                                <li><a href="{{route('routs.index')}}">Routes</a></li>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="footer-widget footer-nav-widget mb-5 mb-sm-0">
                                            ...
                                            <li><a href="{{route('home.index')}}">Home</a></li>
                                                ...
                                                <li><a href="{{route('policy')}}">Term & Condition </a></li>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-5">
                                ...
                                <p>Design & Developed By : <a href="{{route('home.index')}}">mSquare info tech</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Button trigger modal -->
                                ...
                                <div class="product_feature_img_slider swiper">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{asset('front-assets/assets/img/home4/pd-1.jpg')}}" alt="feature img" class="img-fluid">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('front-assets/assets/img/home4/pd-1.jpg')}}" alt="feature img" class="img-fluid">
                                        </div>
    ...
    <script src="{{asset('front-assets/assets/js/vendors/jquery.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/jquery-ui.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/appear.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/popper.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/bootstrap.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/easing.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/swiper.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/massonry.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/bootstrap-slider.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/magnific-popup.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/waypoints.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/counterup.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/isotop.pkgd.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/moment.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/date-picker.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/progressbar.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/slick.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/countdown.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/custom-scrollbar.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/price-range.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/vendors/image-rotate.min.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/app.js')}}"></script>
    <script src="{{asset('front-assets/assets/js/select2.min.js')}}"></script>
    
    <script src="https://cdnjs.cloudflare.com/ajax/libs/tether/1.4.0/js/tether.min.js" integrity="sha384-DztdAPBWPRXSA/3eYEEUWrWCy7G5KFbe8fFjk5JAIxUYHKkDx6Qin1DkWx51bBrb" crossorigin="anonymous"></script>
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.3/jquery.min.js"></script> -->
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js" integrity="sha384-vBWWzlZJ8ea9aCX4pEW3rVHjgjt7zpkNpZk+02D9phzyeVkE+jo0ieGizqPLForn" crossorigin="anonymous"></script>
<script type="text/javascript" src="{{asset('front-assets/assets/js/mdb.min.js')}}"></script>
        <script>
       console.clear();
</script>
<script>
                      ...
                      $('#request_callback_button').click(function()
                      {
                          ...
                          if(mobile_no=='' || mobile_no.length!=10)
                              ...
                              else
                              {
                                  $.ajax({
                                      type: "POST",
                                      url:"{{route('contact_inquiry.index')}}",
