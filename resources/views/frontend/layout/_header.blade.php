...
<body>
    ...
    <div class="main-wrapper">
                        ...
                        <div class="col-xl-8 col-lg-7 col-4">
                            <div class="tp-info-wrapper d-flex align-items-center justify-content-end">
                                ...
                                <div class="tp-info d-inline-flex align-items-center">
                                    ...
                                    <p class="mb-0">+91 {{helpers::mobile()}}</p>
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-6 col-lg-3">
                            <div class="logo-wrapper">
                                <a href="{{route('home.index')}}"><img src="{{asset('front-assets/assets/img/logo.png')}}" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-6 col-lg-9">
                            <div class="at_header_right d-flex align-items-center justify-content-end">
                                <nav class="at_nav_menu d-none d-lg-block">
                                    <ul> 
                                        <li><a class="{{Request::is('/') ? 'menu_active':''}}" href="{{route('home.index')}}">Home</a></i>
                                        <li><a class="{{Request::is('about-us') ? 'menu_active':''}}" href="{{route('about.index')}}">About us</a></li>
                                           <li><a class="{{Request::is('service') ? 'menu_active':''}}" href="{{route('service')}}">Service</a></i>
                                           <li><a class="{{Request::is('oneway-routs') ? 'menu_active':''}}" href="{{route('routs.index')}}">Routes</a></i>
                                           <li><a class="{{Request::is('contact-us') ? 'menu_active':''}}" href="{{route('contact.index')}}">Contact us</a></i>
                                           @if(session()->get('user_mobile'))
                                           <li><a  class="{{Request::is('myaccount') ? 'menu_active':''}}" href="{{route('myaccount')}}">My Account</a></i></li>
                                           <li><a href="{{route('logout')}}">Logout</a></i></li>
                                           @else
                                           <li><a class="{{Request::is('user-register') ? 'menu_active':''}} {{Request::is('signup') ? 'menu_active':''}} "  href="{{route('ragister.index')}}">Login/Register</a></i></li>
                                           @endif
        ...
        <div class="mobile-menu position-fixed bg-white deep-shadow">
            ...
            <a href="{{route('home.index')}}" class="logo-wrapper bg-secondary d-block mt-4 p-3 rounded-1 text-center"><img src="{{asset('front-assets/assets/img/logo.png')}}" alt="logo" class="img-fluid"></a>
            <nav class="mobile-menu-wrapper mt-40">
                ...
                <li><a class="{{Request::is('/') ? 'menu_active':''}}" href="{{route('home.index')}}">Home</a></i>
                                        <li><a class="{{Request::is('about-us') ? 'menu_active':''}}" href="{{route('about.index')}}">About us</a></li>
                                           ...
                                           <li><a href="{{route('logout')}}">Logout</a></i></li>
                                           @else
                                           <li><a href="{{route('ragister.index')}}">Login/Register</a></i></li>
                                           @endif
                </ul>
        ...
        <div class="at_offcanvus_menu position-fixed">
            ...
            <div class="offcanvus-contact">
                ...
                <ul class="at_canvus_address">
                    <li>{{helpers::address()}}</li>
                    <li>{{helpers::mobile()}}</li>
                    <li>{{helpers::email()}}</li>
                </ul>
            </div>
