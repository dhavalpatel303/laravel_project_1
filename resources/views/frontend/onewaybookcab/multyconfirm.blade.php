            ...
            <div class="col-xl-12 col-lg-12">
                <div class="about-right mt-5 mt-lg-0">
                    ...
                    <div class="about-icon-box bg-white shadow rounded mt-20">
                        ...
                        <p>A confirmation email has been sent to your provided email addre/b></p>
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="pt-4 pb-5 px-5 border-bottom">
                                    ...
                                    <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                                        ...
                                        <li class="d-flex justify-content-between py-2">
                                            <span class="font-weight-medium">Travel City</span>
                                            <?php
                                                    $data2= str_replace("||","-",$data->travel_city);
                                                    ?>
                                            <span class="text-secondary text-right">{{$data2}}</span>
                                        </li>
