            ...
            jQuery.ajax({
              ...
              'X-CSRF-Token': $('input[name="_token"]').val()
                ...
                success:function(data){ 
                        ...
                        jQuery('#total_amount').val(data.gross_total);
            ...
            jQuery.ajax({
              ...
              'X-CSRF-Token': $('input[name="_token"]').val()
                ...
                success:function(data){
                    ...
                    jQuery('#local_total_amount').val(data.gross_total)
...

            {
              ...
              'X-CSRF-Token': $('input[name="_token"]').val()
                        ...
                        success: function(data){
                            ...
                            $('#round_total_amount').val(data.gross_total);
                            }
                        }
                        });
                }
       ...
       $(add_button).click(function(e) { //on add input button click
           ...
           if(t_check == '') {
               ...
               if(x < max_fields){ //max input box allowed
                   ...
                   $('.extra_input').append(
                    '<div class="col-md-12"><div class="form-group" id="appendDiv_id'+x+'" style="margin-top:-30px"><label id="lable-travel'+x+'" style="font-size:15px;"></label><input type="text" style="margin-top: 10px;width: 110%;margin-left:-10px"; class="mul_city form-control pac-target-input" id="travel_cities'+x+'" name="travel_cities[]" placeholder="Enter a Location" autocomplete="off"></div></div>');
                       set_code();
                   }
           }
       });
