    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><span class="font-weight-semibold">Edit Withdrawal </span></h4>
            </div>
            ...
            <div class="col-md-6 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::model($ticket, ['method' => 'PATCH','route' => ['ticket.update', encrypt($ticket->id)]]) !!}
                        <div class="row">
                        ...
                        <div class="form-group mb-3 mb-md-3">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" {{ ($ticket->status == '0') ? 'checked' : '' }} name="status" id="status" value="0">
                                        <label class="custom-control-label" for="status">Approve</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" {{ ($ticket->status == '1') ? 'checked' : '' }} name="status" id="status1" value="1">
                                        <label class="custom-control-label" for="status1">Reject</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" {{ ($ticket->status == '2') ? 'checked' : '' }} name="status" id="status2" value="2">
