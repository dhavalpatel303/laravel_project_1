...
<?php elseif(Request::is('oneway-routs')): ?>
...
<?php elseif(Request::is('contact-us')): ?>
<title>Best Taxi Booking Service, Car Rental - Cab Book Karo</title>
<meta name="description" content="Whether you need a ride to the airport, a night out, or just around town, we've got you covered.Book now and enjoy a hassle-free experience!">
<meta name="keywords" content=" One way cab surat, Taxi Service in mumbai " />
<?php else: ?>
...
<head>
    ...
    <!--favicon icon-->
    <link rel="icon" href="<?php echo e(asset('front-assets/assets/img/favicon.png')); ?>" type="image/png" sizes="16x16" />
    ...
    <!--custom css-->
    <link rel="stylesheet" href="<?php echo e(asset('front-assets/assets/css/custom.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front-assets/assets/css/select2.min.css')); ?>" />
    
    <!-- <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" /> -->
<!-- <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script> -->

</head><?php /**PATH C:\xampp\htdocs\demo_web\resources\views/frontend/layout/_top_bar.blade.php ENDPATH**/ ?>