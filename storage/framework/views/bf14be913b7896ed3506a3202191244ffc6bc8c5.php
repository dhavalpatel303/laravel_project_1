        ...
        <div class="col-xl-4">
                <div class="order-sidebar bg-white rounded mt-30">
                    ...
                    <a href="#" class="d-block mb-3">
                                    <img class="img-fluid rounded-xs" src="<?php echo e(asset('public/profile/'.$cab->image)); ?>" alt="Image-Description">
                    </a>
                    <div class="col-md-12">
                    <h5 class="text_center"><?php echo e($cab->cab); ?></h5>
                    </div>
                    <table class="w-100"> 
                        <tbody>
                            <tr>
                                <td><b>Pickup City</b></td>
                                <td><?php echo e($local_pickcity->pick_city); ?></td>
                            </tr>
                            <tr>
                                <td><b>Local Package </b></td>
                                <td><?php echo e($package->local_package); ?></td>
                            </tr>
                            <tr>
                                <td><b>Including KM`S</b></td>
                                <td><?php if($package->local_package == '4Hr/40KMs' ): ?>
                                                        40 Km
                                                        <?php elseif($package->local_package == '6Hr/60KMs'): ?>
                                                        60 Km
                                                        <?php elseif($package->local_package == '8Hr/80KMs'): ?>
                                                        80 Km
                                                        <?php elseif($package->local_package == '10Hr/100KMs'): ?>
                                                        100 Km
                                                        <?php else: ?>
                                                        120 Km
                                                        <?php endif; ?></td>
                                ...
                                <td><i class="fa fa-inr"></i><?php if($package->local_package == '4Hr/40KMs' ): ?>
                                                            4 Hours
                                                            <?php elseif($package->local_package == '6Hr/60KMs'): ?>
                                                            6 Hours
                                                            <?php elseif($package->local_package == '8Hr/80KMs'): ?>
                                ...
                                <td><i class="fa fa-inr"></i><?php echo e($local_pick_city->ehr); ?>/-</td>
                            </tr>   <tr>
                                <td><b>Extra Km Rate</b></td>
                                <td><i class="fa fa-inr"></i><?php echo e($local_pick_city->ekr); ?>/-</td>
                            </tr>    <tr>
                                <td><b>Gross Total</b></td>
                                <td><i class="fa fa-inr"></i><?php echo e($local_pick_city->total_amount); ?>/-</td>
                            </tr>   <tr>
                                <td><b>Discount</b></td>
                    ...
                    <?php echo Form::text('promo_code', null, array('placeholder' => 'Enter A Promo Code','id'=>'promo_code','name'=>'promo_code','class'=>'form-control')); ?>
                    ...
                    <table class="w-100">
                        <tbody>
                            <tr>
                                <th>Total:</th>
                                <th  id="leftamount"><i class="fa fa-inr"></i><?php echo e($local_pick_city->total_amount); ?>/-</th>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="col-xl-8">
                <div class="checkout-box bg-white rounded mt-30">
                    ...
                    <span class="spacer"></span>
                    <?php echo Form::open(array('route' => 'localbookcab.store','class'=>'checkout-form mt-30','method'=>'POST','id'=>'local_booking','files' => 'true','enctype'=>'multipart/form-data')); ?>

                    <input id="pickupcity_id" name="pickupcity_id" type="hidden" value="<?php echo e($local_pickcity->id); ?>">
                                    
                                    <input id="user_id" name="user_id" type="hidden" value="<?php echo e($user_id->id); ?>">
                                    <input id="cab_type" name="cab_type" type="hidden" value="<?php echo e($local_pick_city->cab_type); ?>">
                                    <!-- <input id="userid" name="userid" type="hidden" value="<?php echo e($userid); ?>"> -->
                                    <input type="hidden" name="dropcity" id="dropcity" value="<?php echo e($package->local_package); ?>">
                                    <input type="hidden" name="total_amount" id="leftamount" value="<?php echo e($local_pick_city->total_amount); ?>">
                                    <input id="localdetail_id" name="localdetail_id" type="hidden">
                                    <input id="gross_amount" name="gross_amount" type="hidden"value="<?php echo e($local_pick_city->total_amount); ?>">
                                     <input type="hidden" id="gross_total" name="gross_total" value="<?php echo e($local_pick_city->total_amount); ?>">
                                    <input type="hidden" name="discount" id="discount" value="">
                                    <input type="hidden" name="total_input" id="total_input" value="">
                                    <input type="hidden" name="amountDiscount" id="amountDiscount" value="<?php echo e($local_pick_city->total_amount); ?>">  
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="input-field">
                                    <label>Cutomer Name</label>
                                    <input type="text" id="local_customer_name" placeholder="Enter Your Name" class="w-100 border rounded" required name="customer_name"  value="<?php echo e($user_id->name); ?>">
                            ...
                            <div class="col-lg-4">
                                <div class="input-field">
                                    ...
                                    <input id="local_email"  class="w-100 border rounded"  placeholder="Enter Email Address" required name="email" type="email" value="<?php echo e($user_id->email); ?>">
                            ...
                            <div class="col-lg-4">
                                <div class="input-field">
                                    ...
                                    <input id="local_customer_mobile" class="w-100 border rounded" pattern="/^-?\d+\.?\d*$/" onkeypress="if(this.value.length==10) return false;" name="customer_mobile" type="text" value="<?php echo e($user_id->user_mobile); ?>" readonly="true">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="input-field">
                            ...
                            <div class="col-lg-6">
                                ...
                                <?php echo Form::number('alternet_mobile', null, array('id'=>'alternet_mobile','class'=>'w-100 border roundedform-control','pattern'=>'"/^-?\d+\.?\d*$/"' ,'onKeyPress'=>'if(this.value.length==10) return false','placeholder'=>'Enter Alternet Mobile')); ?>
                            ...
                            <div class="col-lg-6">
                                ...
                                <?php echo Form::text('flight_number', null, array('id'=>'flight_number','class'=>'w-100 border rounded','placeholder'=>'Enter Flight Number')); ?>

                                
                                </div>
                             
                            </div>
                            <h4>INR : <?php echo e($local_pick_city->total_amount); ?>/-</h4><br>
                            <br>
                            <h4>Note : </h4>
        ...
        <div class="col-xl-4">
                <div class="order-sidebar bg-white rounded mt-30">
                    ...
                    <table class="w-100"> 
                        <tbody>
                            <tr>
                                <td><b>Pickup City</b></td>
                                <td><?php echo e($pickcity->pick_city); ?></td>
                            </tr>
                            <tr>
                                <td><b>Drop City</b></td>
                                <td><?php echo e($dropcity->drop_city); ?></td>
                            </tr>
                            <tr>
                                <td><b>Estimate Km</b></td>
                                <td><?php echo e($pick_city_id->km); ?> Km</td>
                            </tr>   <tr>
                                <td><b>Base Fare</b></td>
                                <td><i class="fa fa-inr"></i><?php echo e($pick_city_id->amount); ?>/-</td>
                            </tr>   <tr>
                                <td><b>Toll Tax</b></td>
                                <td><i class="fa fa-inr"></i><?php if($pick_city_id->tax==''): ?> Include <?php else: ?> <?php echo e($pick_city_id->tax); ?>/- <?php endif; ?></td>
                            </tr>   <tr>
                                <td><b>State Tax</b></td>
                                <td><i class="fa fa-inr"></i><?php if($pick_city_id->state_tax==''): ?>Include <?php else: ?> <?php echo e($pick_city_id->state_tax); ?>/-<?php endif; ?></td>
                            </tr>   <tr>
                                <td><b>Driver allowance</b></td>
                                <td><i class="fa fa-inr"></i><?php if($pick_city_id->driver_allowance==''): ?>Include <?php elseif($pick_city_id->driver_allowance==0): ?>Include <?php else: ?> <?php echo e($pick_city_id->driver_allowance); ?>/- <?php endif; ?></td>
                            </tr>   <tr>
                                <td><b>Gross Total</b></td>
                                <td><i class="fa fa-inr"></i><?php echo e($pick_city_id->total_amount); ?>/-</td>
                            </tr>   <tr>
                                <td><b>Discount</b></td>
                                <td id="leftdiscount"><i class="fa fa-inr"></i>0/-</td>
                    ...
                    <table class="w-100">
                        <tbody>
                            <tr>
                                <th>Total:</th>
                                <th  id="leftamount"><i class="fa fa-inr"></i><?php echo e($pick_city_id->total_amount); ?>/-</th>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="col-xl-8">
                <div class="checkout-box bg-white rounded mt-30">
                    <h4 class="mb-3">Billing Details</h4>
                    <span class="spacer"></span>
                    <?php echo Form::open(array('route' => 'onewaybookcab.store','class'=>'checkout-form mt-30','method'=>'POST','id'=>'oneway_booking','files' => 'true','enctype'=>'multipart/form-data')); ?>

                    <input id="pickupcity_id" name="pickupcity_id" type="hidden" value="<?php echo e($pickcity->id); ?>">
                                <input id="dropcity_id" name="dropcity_id" type="hidden" value="<?php echo e($dropcity->id); ?>">
                                <input id="user_id" name="user_id" type="hidden" value="<?php echo e($user_id->id); ?>">
                                <input id="cab_type" name="cab_type" type="hidden" value="<?php echo e($pick_city_id->cab_type); ?>">
                                <!-- <input id="userid" name="userid" type="hidden" value="<?php echo e($userid); ?>"> -->
                                <input type="hidden" name="total_amount" id="leftamount" value="<?php echo e($pick_city_id->total_amount); ?>">
                                <input id="onewaydetail_id" name="onewaydetail_id" type="hidden">
                                <input id="gross_amount" name="gross_amount" type="hidden"value="<?php echo e($pick_city_id->total_amount); ?>">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="input-field">
                                    <label>Cutomer Name</label>
                                    <input type="text" id="customer_name" placeholder="Enter Your Name" class="w-100 border rounded" required name="customer_name"  value="<?php echo e($user_id->name); ?>">
                            ...
                            <div class="col-lg-4">
                                <div class="input-field">
                                    <label>Email Address*</label>
                                    <input id="email"  class="w-100 border rounded"  placeholder="Enter Email Address" required name="email" type="email" value="<?php echo e($user_id->email); ?>">
                            ...
                            <div class="col-lg-4">
                                <div class="input-field">
                                    <label>Mobile Number*</label>
                                    <input id="customer_mobile" class="w-100 border rounded" pattern="/^-?\d+\.?\d*$/" onkeypress="if(this.value.length==10) return false;" name="customer_mobile" type="text" value="<?php echo e($user_id->user_mobile); ?>" readonly="true">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="input-field">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="hidden" id="gross_total" name="gross_total" value="<?php echo e($pick_city_id->total_amount); ?>">
                                            <input type="hidden" name="discount" id="discount" value="">
                                            <input type="hidden" name="total_input" id="total_input" value="">
                                            <input type="hidden" name="amountDiscount" id="amountDiscount" value="<?php echo e($pick_city_id->total_amount); ?>">
                            </div>
                            <h4>INR : <?php echo e($pick_city_id->total_amount); ?>/-</h4><br>
                            <br>
                            <h4>Note : </h4>
                            <div class="col-lg-12 mt_20">
                                <div class="alternate-shipping">
             ...
             <script>
                jQuery(document).ready(function()
                {
                        jQuery('#apply_promo').click(function()
                        {
                            ...
                            type:'post',
                            url:"<?php echo e(route('coupon_check')); ?>",
...
<?php /**PATH C:\xampp\htdocs\demo_web\resources\views/frontend/onewaybookcab/index.blade.php ENDPATH**/ ?>