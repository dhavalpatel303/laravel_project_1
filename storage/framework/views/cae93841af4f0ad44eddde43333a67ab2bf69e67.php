    ...
    <?php echo $__env->make('frontend.layout._top_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <section class="about-section pt-120 pb-50 bg-primary-light position-relative z-1 overflow-hidden" data-background="<?php echo e(asset('front-assets/assets/img/shapes/about-bg.jpg')); ?>" style="background-image: url(&quot;<?php echo e(asset('front-assets/assets/img/shapes/about-bg.jpg')); ?>&quot;);">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="about-left position-relative z-1">
                            ...
                            <img src="<?php echo e(asset('front-assets/assets/img/home1/car-red.png')); ?>" alt="car" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
...
<?php /**PATH C:\xampp\htdocs\demo_web\resources\views/frontend/about/index.blade.php ENDPATH**/ ?>